...
Get a working contact form with google reCaptcha on the page for free'
    ...
    'contactForm' => [
        'link' => 'https://www.fiverr.com/s2/11a7b8bc1e',
        'message' => 'Get a functional contact form or any other form of your choice for your business at $5 (exclusively on Fiverr)
The form will be made based on your criteria with all the security measures taken to save you from spammer. https://www.fiverr.com/s2/fe19bf8d7a'
    ]
];
...
if ($gigs && $groupNames) {
    ...
    $mail->Body = $msg . "<br/> Sent from post3.";
